...
file_source_location_stream_4 = "/data/streamingdemos/bronze_watertemperaturesensor/"
file_sink_location_stream_4 = "/data/streamingdemos/silver_watertemperaturesensor/"
...
if runMode == "Static":
  ...
  stream4Controller(stream4_df, 1)
